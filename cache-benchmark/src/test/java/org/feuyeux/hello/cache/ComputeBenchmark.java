...
public class ComputeBenchmark {
  ...
  private void setupCache2k() {
    org.cache2k.Cache<Integer, Boolean> cache = Cache2kBuilder.of(Integer.class, Boolean.class)
        .build();
  ...
  public void test() throws RunnerException {
    Options opt = new OptionsBuilder().include(ComputeBenchmark.class.getSimpleName())
